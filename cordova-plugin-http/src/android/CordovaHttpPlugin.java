...
public class CordovaHttpPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        if (action.equals("get")) {
			...
			Boolean autoencode=args.getBoolean(4);
            ...
            CordovaHttpGet get = new CordovaHttpGet(urlString, paramsMap, headersMap,charset,autoencode, callbackContext);
            ...
            HashMap<?, ?> paramsMap = this.getMapFromJSONObject(params);
            HashMap<String, String> headersMap = this.getStringMapFromJSONObject(headers);
            CordovaHttpHead head = new CordovaHttpHead(urlString, paramsMap, headersMap,charset,autoencode, callbackContext);
            ...
            HashMap<?, ?> paramsMap = this.getMapFromJSONObject(params);
            HashMap<String, String> headersMap = this.getStringMapFromJSONObject(headers);
            CordovaHttpPost post = new CordovaHttpPost(urlString, paramsMap, headersMap,charset, callbackContext);
	...
	String charset = args.getString(3);
	HashMap<String, String> headersMap = this.getStringMapFromJSONObject(headers);
	CordovaHttpPostJson postJson = new CordovaHttpPostJson(urlString, jsonObj, headersMap,charset, callbackContext);
	cordova.getThreadPool().execute(postJson);			
            ...
            HashMap<?, ?> paramsMap = this.getMapFromJSONObject(params);
            HashMap<String, String> headersMap = this.getStringMapFromJSONObject(headers);
            String filePath = args.getString(4);
            String name = args.getString(5);
            CordovaHttpUpload upload = new CordovaHttpUpload(urlString, paramsMap, headersMap,charset, callbackContext, filePath, name);
            ...
            HashMap<?, ?> paramsMap = this.getMapFromJSONObject(params);
            HashMap<String, String> headersMap = this.getStringMapFromJSONObject(headers);
            String filePath = args.getString(5);
            CordovaHttpDownload download = new CordovaHttpDownload(urlString, paramsMap, headersMap,charset,autoencode, callbackContext, filePath);
