...
public class CordovaHttpDownload extends CordovaHttp implements Runnable {
    ...
    public CordovaHttpDownload(String urlString, Map<?, ?> params, Map<String, String> headers,String charset,Boolean autoencode, CallbackContext callbackContext, String filePath) {
    ...
    public void run() {
        try {
            HttpRequest request = HttpRequest.get(this.getUrlString(), this.getParams(),  this. getautoencode());
