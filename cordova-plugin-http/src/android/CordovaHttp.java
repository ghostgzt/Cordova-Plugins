...
private JSONObject jsonObject;	
 ...
 public CordovaHttp(String urlString, JSONObject jsonObj, Map<String, String> headers,String charset,Boolean autoencode, CallbackContext callbackContext) {
...
this.autoencode=autoencode;
    ...
    public CordovaHttp(String urlString, Map<?, ?> params, Map<String, String> headers,String charset,Boolean autoencode, CallbackContext callbackContext) {
        this.urlString = urlString;
this.charset=charset;
this.autoencode=autoencode;
        this.params = params;
...
protected Boolean getautoencode() {
...
protected JSONObject getJsonObject() {
    ...
    protected void addResponseHeaders(HttpRequest request, JSONObject response) throws JSONException {
        ...
        Map<String, Object> parsed_headers = new HashMap<String, Object>();
