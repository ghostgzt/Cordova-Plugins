...
public class CordovaHttpUpload extends CordovaHttp implements Runnable {
    ...
    public CordovaHttpUpload(String urlString, Map<?, ?> params, Map<String, String> headers,String charset, CallbackContext callbackContext, String filePath, String name) {
